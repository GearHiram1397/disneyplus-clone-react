...
import { selectUserName, selectUserAvatar, setUserLoginDetails, setSignOutState } from '../features/user/userSlice'
const Header = (props) => {
  ...
  return (
    <Nav>
        ...
        {!userName ? (<Login onClick={handleUserLogin}>Login</Login>) : (<>
        <NavMenu>
            <a href="/home">
        ...
        <SignOut>
        <UserImg src={userAvatar} alt={userName} />
        <DropDown>
            <span onClick={handleUserLogout}>Sign Out</span>
        </DropDown>
        </SignOut>
        </>) }
    </Nav>
